package com.mastercard.placesreferenceapplication.service;
...
public class PlaceServiceTest {
    @InjectMocks
    private DefaultPlaceService classUnderTest;

    @Test
    public void testGetErrorAttributes_handlePlacesServiceException() {
        String result = classUnderTest.getErrorAttributes(new PlacesServiceException(new Exception("Something went wrong")));
